    ...
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <div class="flex gap-2">
                <select wire:model="country_code" id="country_code" name="country_code" class="block w-1/4 border-gray-300 rounded-md shadow-sm">
                    <option value="+502">🇬🇹 +502</option>
                    <option value="+1">🇺🇸 +1</option>
                    <option value="+52">🇲🇽 +52</option>
                    <!-- Agrega más países aquí -->
                </select>
                <x-text-input wire:model="phone" id="phone" class="block w-3/4 mt-1 w-full" type="tel" name="phone" required />
            </div>
